...
const handleGoogleLogin = () => {
  googleLogin()
    ...
    return (
      <div className="md:my-20 max-w-[1296px] mx-auto">
      <div className=" hidden md:grid grid-cols-2 items-center  gap-6  border  mx-auto  ">
      ...
      <button onClick={handleGoogleLogin} href="#" className="flex items-center justify-center   transition-colors duration-300 transform border rounded-lg btn px-11  hover:bg-gray-50 ">
        ...
        <span>Facebook</span>
          ...
          <div
          className="hidden h-[800px] w-full lg:flex lg:items-center lg:justify-center text-center bg-cover rounded-2xl bg-no-repeat m-4 "
          style={{
